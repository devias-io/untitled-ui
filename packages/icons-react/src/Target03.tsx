...
const Target03 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M12 19.2c3.9765 0 7.2-3.2235 7.2-7.2 0-3.9764-3.2235-7.2-7.2-7.2-3.9764 0-7.2 3.2236-7.2 7.2 0 3.9765 3.2236 7.2 7.2 7.2Z"
    />
    <path
      fill="#fff"
      fillOpacity={0.01}
