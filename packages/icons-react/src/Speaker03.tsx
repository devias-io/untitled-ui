...
const Speaker03 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M3 7.32c0-1.5121 0-2.2682.2943-2.8458a2.7 2.7 0 0 1 1.18-1.18C5.0517 3 5.8078 3 7.32 3h7.56c1.5121 0 2.2682 0 2.8458.2943.508.2588.9211.6719 1.1799 1.18.2943.5775.2943 1.3336.2943 2.8457v5.76c0 1.5121 0 2.2682-.2943 2.8458a2.6996 2.6996 0 0 1-1.1799 1.1799c-.5776.2943-1.3337.2943-2.8458.2943H7.32c-1.5121 0-2.2682 0-2.8458-.2943a2.6998 2.6998 0 0 1-1.18-1.1799C3 15.3482 3 14.5921 3 13.08V7.32Z"
    />
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M11.1 14.7c2.4853 0 4.5-2.0147 4.5-4.5s-2.0147-4.5-4.5-4.5-4.5 2.0147-4.5 4.5 2.0147 4.5 4.5 4.5Z"
    />
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M11.55 10.2a.45.45 0 1 1-.9 0 .45.45 0 0 1 .9 0Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
