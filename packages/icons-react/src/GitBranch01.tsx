...
const GitBranch01 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M18 11c1.6569 0 3-1.3431 3-3s-1.3431-3-3-3-3 1.3431-3 3 1.3431 3 3 3Zm0 10c1.6569 0 3-1.3431 3-3s-1.3431-3-3-3-3 1.3431-3 3 1.3431 3 3 3Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
