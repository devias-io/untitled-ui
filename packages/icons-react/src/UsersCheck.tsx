...
const UsersCheck = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="m15.6 16.5 1.8 1.8 3.6-3.6M9.75 10.2c1.9882 0 3.6-1.6118 3.6-3.6 0-1.9882-1.6118-3.6-3.6-3.6-1.9882 0-3.6 1.6118-3.6 3.6 0 1.9882 1.6118 3.6 3.6 3.6Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
