...
const FaceSmile = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M8.4 12.8s1.35 1.8 3.6 1.8 3.6-1.8 3.6-1.8m-.45-4.5a.45.45 0 1 1-.9 0 .45.45 0 0 1 .9 0Zm-5.4 0a.45.45 0 1 1-.9 0 .45.45 0 0 1 .9 0Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
