...
const Copy04 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="transparent"
      fillOpacity={0.01}
      d="M8.4 5.88c0-1.008 0-1.5121.1962-1.8972a1.8 1.8 0 0 1 .7866-.7866C9.7678 3 10.272 3 11.28 3h6.84c1.0081 0 1.5121 0 1.8972.1962a1.8 1.8 0 0 1 .7866.7866C21 4.3678 21 4.872 21 5.88v6.84c0 1.0081 0 1.5121-.1962 1.8972a1.8 1.8 0 0 1-.7866.7866c-.3851.1962-.8891.1962-1.8972.1962h-6.84c-1.0081 0-1.5121 0-1.8972-.1962a1.8 1.8 0 0 1-.7866-.7866C8.4 14.2321 8.4 13.7281 8.4 12.72V5.88Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
