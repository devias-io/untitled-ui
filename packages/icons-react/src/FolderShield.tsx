...
const FolderShield = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="transparent"
      fillOpacity={0.01}
      d="M12 16.05s2.7-1.2869 2.7-3.2173v-2.2521l-1.9688-.7035a2.17 2.17 0 0 0-1.4634 0L9.3 10.5806v2.2521C9.3 14.7631 12 16.05 12 16.05Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
