...
const Building04 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#fff"
      fillOpacity={0.01}
      d="M14.8 3H9.2c-1.1201 0-1.6802 0-2.108.218a1.9999 1.9999 0 0 0-.874.874C6 4.5198 6 5.08 6 6.2V21h12V6.2c0-1.1201 0-1.6802-.218-2.108a1.9997 1.9997 0 0 0-.874-.874C16.4802 3 15.9201 3 14.8 3Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
